...
.EXAMPLE
    .\scripts\run_full_pipeline_legacy.ps1 -Device cuda
    .\scripts\run_full_pipeline_legacy.ps1 -Smoke -Device cpu
    .\scripts\run_full_pipeline_legacy.ps1 -Wandb -WandbMode offline
#>
