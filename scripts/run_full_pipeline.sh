...
#   bash scripts/run_full_pipeline.sh --device cuda
#
#   # Fast local smoke verification (1-2 steps, CPU safe)
#   bash scripts/run_full_pipeline.sh --smoke --device cpu
#
#   # Enable offline WandB tracking
#   bash scripts/run_full_pipeline.sh --wandb --wandb_mode offline
#
#   # Resume from Phase B using an existing Phase A checkpoint
#   bash scripts/run_full_pipeline.sh --start_phase B
# ==============================================================================
