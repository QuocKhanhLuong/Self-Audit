"""Config freeze/validate and raw-partition bundle sealing for STEGO."""
...
def create_freeze(config_dict: dict[str, Any]) -> dict[str, Any]:
    ...
    freeze = {
        "schema_version": "stego.cardiac.freeze.v1",
        "model_type": config_dict["model_type"],
        "checkpoint_sha256": config_dict.get("checkpoint_sha256", ""),
        "n_classes": config_dict["n_classes"],
        "resolution": config_dict["resolution"],
        "dim": config_dict["dim"],
        "normalization": config_dict.get("normalization", "stego.cardiac.fixed_affine_v1"),
...
def seal_raw_bundle(
    ...
    *,
    ...
    bundle = {
        "schema_version": "stego.cardiac.raw-bundle.v1",
        "entries": entries,
...
def evaluator_skeleton(
    ...
    *,
    ...
    receipt = {
        "schema_version": "stego.cardiac.evaluator-skeleton.v1",
